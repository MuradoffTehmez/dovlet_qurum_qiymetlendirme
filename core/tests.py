...
class AuthenticationFlowsTests(BaseTestCase):
    ...
    def test_password_reset_flow(self):
        """Şifrə bərpası axınının tam olaraq işləməsi."""
        ...
        # GET sorğusu linkə göndərilir
        response_get = self.client.get(reset_link)
        self.assertEqual(response_get.status_code, 200)

        # POST sorğusu ilə yeni şifrə təyin edilir
        response_post = self.client.post(reset_link, {'new_password1': 'yeniGucluShifre456', 'new_password2': 'yeniGucluShifre456'})
        ...
        # Yeni şifrə ilə daxil olmaq yoxlanılır
